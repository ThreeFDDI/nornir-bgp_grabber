...
'''
This script uses the Nornir framework to collect BGP routes from 
...
def kickoff():
    ...
    print()
    print('~'*80)
    c_print('This script will gather BGP routes from Cisco devices')
...
def grab_info(task):
    # show ip bgp command
    cmd = f"sh ip bgp regex {task.host['asn']}$"
